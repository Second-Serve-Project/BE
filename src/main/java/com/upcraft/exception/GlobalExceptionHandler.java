...
public class GlobalExceptionHandler {
    ...
    public ResponseDto<Map<String, Object>> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        return ResponseDto.fromResultStatusWithData(ResultStatus.FORBIDDEN, errors);
    }
